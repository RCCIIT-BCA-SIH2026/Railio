...
// Primary immediate screens for instantaneous startup
  ...
  return (
    <Animated.View style={{ transform: [{ translateY }], alignItems: 'center', width: 120, zIndex: 100 }}>
       <View style={{ backgroundColor: '#F1F5F9', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 8, borderBottomRightRadius: 0, marginBottom: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 1 }}>
         <Text style={{ fontSize: 9, fontFamily: 'PlaypenSans-SemiBold', color: '#0F172A', textAlign: 'center' }}>Hi I am Railio</Text>
       </View>
  ...
  return (
    ...
    >
      <Tab.Screen
        ...
        options={{
          tabBarLabel: 'Home',
          tabBarIcon: ({ color, size }) => <Home color={color} size={20} strokeWidth={2.5} />,
        }}
      />
      <Tab.Screen
        name="TrainsTab"
      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => <MapPin color={color} size={20} strokeWidth={2.5} />,
        }}
      />
      <Tab.Screen
        name="ProfileTab"
