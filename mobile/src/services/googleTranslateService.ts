...
export const UI_DICTIONARY: Record<string, Record<string, string>> = {
  ...
  'search over 20+ express, rajdhani, and vande bharat trains': { en: 'Search over 40+ Sealdah ⇄ Dankuni UP/DOWN EMU local trains', hi: '40+ सियालदह ⇄ डानकुनी अप/डाउन ईएमयू लोकल ट्रेनें खोजें', bn: '৪০+ শিয়ালদহ ⇄ ডানকুনি আপ/ডাউন ইএমইউ লোকাল ট্রেন খুঁজুন', ta: '40+ சீல்டா ⇄ டன்குனி இஎம்யு லோக்கல் ரயில்களைத் தேடுங்கள்', te: '40+ సీల్దా ⇄ దాన్‌కుని ఈఎంయూ లోకల్ రైళ్లను శోధించండి', mr: '40+ सियालदह ⇄ डानकुनी ईएमयू लोकल गाड्या शोधा', gu: '40+ સિયાલદહ ⇄ ડાનકુની ઈએમયુ લોકલ ટ્રેનો શોધો', kn: '40+ ಸೀಲ್ದಾ ⇄ ಡಾನ್‌ಕುನಿ ಇಎಂಯು ಲೋಕಲ್ ರೈಲುಗಳನ್ನು ಹುಡುಕಿ', ml: '40+ സീൽദാ ⇄ ഡാൻകുനി ഇഎംയു ലോക്കൽ ട്രെയിനുകൾ തിരയുക', pa: '40+ ਸਿਆਲਦਾਹ ⇄ ਡਾਨਕੁਨੀ ਈਐਮਯੂ ਲੋਕਲ ਰੇਲਾਂ ਖੋਜੋ', or: '୪୦+ ଶିଆଲଦା ⇄ ଡାନକୁନି ଇଏମୟୁ ଲୋକାଲ୍ ଟ୍ରେନ୍ ଖୋଜନ୍ତୁ', ur: '40+ سیالدہ ⇄ ڈانکوونی ای ایم یو لوکل ٹرینیں تلاش کریں' },
